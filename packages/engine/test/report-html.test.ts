...
describe("renderReportHtml", () => {
  ...
  it("renders the manifest-backed task-first screenshot review workbench", () => {
    ...
    expect(html).toContain('"Add to export"');
    expect(html).toContain('"Dismiss"');
    expect(html).toContain('text:"Open Image"');
    expect(html).toContain("Note for the handoff (optional)");
    expect(html).toContain("Adjust the highlight");
    ...
    expect(html).toContain("Nothing is in the export yet.");
    ...
    expect(html).toContain("Your unsaved note will be lost. Leave the review now?");
