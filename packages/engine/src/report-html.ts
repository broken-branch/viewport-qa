...
<header class="topbar"><div class="brand">Viewport QA</div><div class="run-title"><strong>Review ${escapeHtml(manifest.pages[0]?.label ?? "screenshots")}</strong><span class="progress" id="progress">0 of ${manifest.captures.length} reviewed</span></div>
<div class="top-actions"><button class="nav-action" id="homeButton">Home</button><button class="nav-action" id="newReviewButton">New Review</button><button class="primary" id="exportButton" data-storage-action aria-label="Export changes, 0 requests" disabled>Export <span id="exportCount">(0)</span></button><button class="icon-button" id="settingsButton" aria-label="Open settings"><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.7 1.7 0 0 0 .3 1.9l.1.1-2.8 2.8-.1-.1a1.7 1.7 0 0 0-1.9-.3 1.7 1.7 0 0 0-1 1.6v.2h-4V21a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.9.3l-.1.1L4.2 17l.1-.1a1.7 1.7 0 0 0 .3-1.9A1.7 1.7 0 0 0 3 14H2.8v-4H3a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.3-1.9L4.2 7 7 4.2l.1.1a1.7 1.7 0 0 0 1.9.3A1.7 1.7 0 0 0 10 3v-.2h4V3a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.9-.3l.1-.1L19.8 7l-.1.1a1.7 1.7 0 0 0-.3 1.9 1.7 1.7 0 0 0 1.6 1h.2v4H21a1.7 1.7 0 0 0-1.6 1Z"></path></svg></button></div></header>
