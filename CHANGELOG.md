...
- Screen size is a toggle in the review, not a filter: the review opens on the narrowest size with each page shown once, another size swaps the view, and *All sizes* shows the variants side by side. "Showing N of M" counts pages, not size variants; issue counts cover every size.
